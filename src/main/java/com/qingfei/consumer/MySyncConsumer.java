        ...
        try {
            while (true) {
                ...
                for (ConsumerRecord<String,byte[]> record:consumerRecords) {
                    System.out.println("MyFirstConsumer's consumption message:partition"+record.partition()+",offset:"+record.offset()+",key="+record.key()+",value="+record.value()+"timestamp:" + record.timestamp() + "timestampType:" + record.timestampType());
