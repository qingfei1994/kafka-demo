...
//  java -cp ~/IdeaProjects/kafka-demo/target/kafka-demo-1.0-SNAPSHOT.jar:/Users/chenhaiqing/kafka/libs/* com.qingfei.producer.MultipleInterceptorProducer
public class MultipleInterceptorProducer {
    public static void main(String[] args) {
        String topic = "interceptor2";
        ...
        kafkaProperties.put(ProducerConfig.INTERCEPTOR_CLASSES_CONFIG, MyInterceptor.class.getName()+"," + MySecondInterceptor.class.getName());
